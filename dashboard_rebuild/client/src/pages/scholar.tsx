           ...
           <div className="space-y-8">
              <Card className="bg-primary/5 border-2 border-primary rounded-none">
                 ...
                 <CardContent className="p-6 space-y-6">
                    ...
                    <Button className="w-full h-12 rounded-none font-arcade bg-primary text-black hover:bg-primary/90 hover:scale-[1.02] transition-transform text-lg border-b-4 border-primary-foreground/20 active:border-0 active:translate-y-1" data-testid="button-run-scholar">
                      <Play className="w-5 h-5 mr-2" /> RUN_SCHOLAR
                    </Button>
                 </CardContent>
              </Card>
              ...
              <Card className="bg-black/40 border-2 border-secondary rounded-none flex-1 min-h-[300px]">
                 ...
                 <CardContent className="p-0">
                    <ScrollArea className="h-[300px] p-4 font-mono text-xs text-white space-y-1">
                       <p>&gt; [10:42:01] Initializing Scholar Agent...</p>
                       <p>&gt; [10:42:02] Connected to Knowledge Graph</p>
                       <p>&gt; [10:42:05] Scanning recent proposals...</p>
                       <p>&gt; [10:42:08] Found {proposals.length} active items.</p>
                       <p className="text-primary">&gt; [10:42:10] READY: Scholar standing by</p>
                       ...
                       {proposals.map((prop) => (
                         <div key={prop.id} className="flex items-center p-4 border-b border-secondary last:border-0 hover:bg-white/5 cursor-pointer font-terminal text-sm group" data-testid={`proposal-${prop.id}`}>
                            ...
                            <div className="flex gap-2 items-center">
                              ...
                              >
                                <SelectTrigger className={`rounded-none w-24 h-8 text-xs ${
                                  prop.status === 'APPROVED' ? 'bg-white text-black' : 
