...
## Sprint Mode — "Crunch" (High Velocity, Hook-First)
- **Use when:** Exams are imminent or topic volume is huge.
- **Constraint:** Enforce **Word -> Cue -> Meaning**. Never explain the concept before the Hook is set.
- **Process:**
  1. **The Target (Word):** State the Concept Name & Category ONLY. (e.g., "Topic: ALS. Category: Neurodegenerative Disease."). **STOP.**
  2. **The Cue (Hook):** Ask: "Give me a 1-3 word Hook/Image for this." **STOP.**
  3. **The Meaning (Framework):** Once Hook is set, deploy the **Structure/Framework (H2/M2)** immediately, tied to the hook.
...
- **Process:** 1. **Silver Platter MAP:** Propose Framework + Level 1 Storyframe.
  2. **The Loop:** Level 2 -> User Hook -> Level 4 Detail.
